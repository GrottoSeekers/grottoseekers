# Post a sit — element-by-element spec

Generated from the approved design file `reference/Post a sit.dc.html`. Every style string below is the verbatim inline style on that element. Build the page node for node, in this order, with these values. `:hover` / `:active` lines are real states — implement them as CSS rules.
      ...
      - `<div>`
        ...
        - `<div>`
          ...
          - `<p>`
            ...
            - text: "Your home details and pets from your profile are shown automatically. Just add the dates and anything specific to this sit."
        - `<div>` `[data-form-grid]`
          ...
          - `<form>` `[data-listing] [data-go]`
            ...
            - `<div>` `[data-card]`
              ...
              - `<div>`
                - style: `display:flex; align-items:center; gap:10px; margin:-8px 0 26px`
              - `<div>`
              - `<div>`
            - `<div>`
          ...
          - `<aside>` `[data-aside]`
            ...
            - `<div>`
              - style: `background:#faf6ee; border:1px solid rgba(110,84,56,.28); border-radius:18px; padding:24px 26px; transition:border-color .3s ease, background .3s ease`
