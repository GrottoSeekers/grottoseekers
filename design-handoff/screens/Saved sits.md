# Saved sits — element-by-element spec

Generated from the approved design file `reference/Saved sits.dc.html`. Every style string below is the verbatim inline style on that element. Build the page node for node, in this order, with these values. `:hover` / `:active` lines are real states — implement them as CSS rules.
        ...
        - `<div>` `[data-two-col]`
          ...
          - `<div>`
            - `<div>`
              ...
              - `<a>` → `Browse sits.dc.html`
                - style: `font-size:.76rem; font-weight:600; letter-spacing:.11em; text-transform:uppercase; color:#2f5d45; display:inline-flex; align-items:center; gap:8px; transition:gap .2s, color .2s`
            ...
            - `<div>`
              ...
              - `<p>`
                ...
                - text: "{{ emptyText }}"
              - `<a>` → `Browse sits.dc.html`
                - style: `display:inline-flex; align-items:center; justify-content:center; font-size:.78rem; font-weight:600; letter-spacing:.1em; text-transform:uppercase; color:#fff; background:#2f5d45; border:1.5px solid #2f5d45; border-radius:50px; box-shadow:0 6px 20px rgba(110,84,56,.28); padding:13px 28px; transition:background .25s ease, border-color .25s ease, transform .15s ease`
                - :hover `background:#3e7a5b;border-color:#3e7a5b;transform:translateY(-2px);box-shadow:0 12px 28px rgba(110,84,56,.36)`
                - text: "Browse open sits"
          - `<aside>` `[data-aside]`
            ...
            - `<div>`
              ...
              - `<p>`
                ...
                - text: "Saved searches"
              - `<p>`
                - style: `font-size:.87rem; color:#6b4e35; line-height:1.7; margin:0 0 20px`
                - text: "We’ll email you when a new sit matches. Off by default — flip the ones you want."
              - `<div>`
                - style: `display:flex; flex-direction:column; gap:12px`
              - `<button>`
                - style: `width:100%; font-family:'Montserrat',sans-serif; font-size:.76rem; font-weight:600; letter-spacing:.1em; text-transform:uppercase; color:#2f5d45; background:#fff; border:1.5px dashed rgba(110,84,56,.5); border-radius:50px; padding:13px 20px; transition:background .25s ease, border-color .25s ease`
            ...
            - `<div>`
              ...
              - `<p>`
                ...
                - text: "How you’re told"
              - `<div>`
                - style: `display:flex; flex-direction:column; gap:12px`
              - `<p>`
                - style: `font-size:.82rem; color:#6b4e35; line-height:1.65; margin:16px 0 0`
                - text: "{{ channelNote }}"
            - `<div>`
              ...
              - `<p>`
                ...
                - text: "Saved sits disappear once the dates pass. {{ expiringLine }}"
