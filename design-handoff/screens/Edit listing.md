# Edit listing — element-by-element spec

Generated from the approved design file `reference/Edit listing.dc.html`. Every style string below is the verbatim inline style on that element. Build the page node for node, in this order, with these values. `:hover` / `:active` lines are real states — implement them as CSS rules.
      ...
      - `<div>`
        ...
        - `<div>`
          ...
          - `<p>`
            ...
            - text: "Change the dates, details or status of this sit. Sitters who’ve already enquired keep their conversation with you."
        - `<div>` `[data-form-grid]`
          - style: `display:grid; grid-template-columns:minmax(0,1.5fr) minmax(0,1fr); gap:28px; align-items:start`
          - `<form>` `[data-listing] [data-go]`
            ...
            - `<div>` `[data-card]`
              ...
              - `<h2>`
                - style: `font-family:'Marcellus',serif; font-size:1.3rem; color:#2c1a0e; margin:0 0 8px`
                - text: "Handover for this sit"
              - `<div>`
                - style: `width:40px; height:2px; background:#6e5438; margin:0 0 12px`
              - `<p>`
                - style: `font-size:.9rem; color:#6b4e35; line-height:1.7; margin:0 0 26px; max-width:480px`
                - text: "Only the parts that change sit to sit. Your address, wifi, vet and house notes come from your profile."
              - `<div>` `[data-date-row]`
                - style: `display:grid; grid-template-columns:1fr 1fr; gap:18px`
              - `<div>`
                - style: `display:flex; align-items:flex-start; gap:13px; background:rgba(110,84,56,.1); border:1px solid rgba(110,84,56,.32); border-radius:12px; padding:16px 18px`
            - `<div>`
            ...
            - `<div>` `[data-card]`
              ...
              - :hover `border-color:rgba(185,28,28,.38)`
              - `<h3>`
                - style: `font-family:'Marcellus',serif; font-size:1.05rem; color:#b91c1c; margin:0 0 8px`
                - text: "Delete this listing"
              - `<p>`
                - style: `font-size:.9rem; color:#6b4e35; line-height:1.65; margin:0 0 18px; max-width:420px`
                - text: "It disappears from browse results straight away. Messages stay in your inbox. This cannot be undone."
              - `<div>`
          - `<aside>` `[data-aside]`
            ...
            - `<div>`
              ...
              - :hover `box-shadow:0 10px 34px rgba(44,26,14,.08);border-color:rgba(110,84,56,.4)`
              - `<div>`
                - style: `padding:20px 24px; border-bottom:1px solid rgba(110,84,56,.2); display:flex; align-items:center; justify-content:space-between; gap:12px`
              - `<div>`
                - style: `padding:22px 24px 26px; background:#faf6ee; display:flex; flex-direction:column; gap:16px`
            - `<div>`
              ...
              - `<p>`
                ...
                - text: "This listing so far"
              - `<div>`
                - style: `display:flex; flex-direction:column; gap:11px; font-size:.88rem; color:#6b4e35; line-height:1.6`
              - `<a>` → `Messages.dc.html`
                - style: `display:inline-flex; align-items:center; gap:8px; font-size:.74rem; font-weight:600; letter-spacing:.12em; text-transform:uppercase; color:#2f5d45; border-bottom:1px solid rgba(110,84,56,.4); transition:gap .2s, color .2s`
